...
execute as @s at @s run summon minecraft:spider ~ ~1.6 ~ {Attributes:[{Name:"generic.movementSpeed",Base:0.5f}],Tags:["gz-a4-newmob"]}
execute as @s[scores={gz-a4-mobamount=2..}] at @s run summon minecraft:spider ~ ~1.6 ~ {Attributes:[{Name:"generic.movementSpeed",Base:0.5f}],Tags:["gz-a4-newmob"]}
